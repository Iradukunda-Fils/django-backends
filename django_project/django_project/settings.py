...
SECRET_KEY = 'django-insecure-98zet_k!ub=h1a+fvdm+@kfmj1ve)y22j&lvj$2vkcp2sw4jfc'
...
AUTH_USER_MODEL = 'account.User'  # Use the custom user model from the account app
